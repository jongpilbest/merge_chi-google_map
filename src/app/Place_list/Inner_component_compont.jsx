...
function Inner_component_compont() {
               ...
               dispatch(InnerComponent_zoom_in([
      {
        location: {
          ...
          lng: data.location.lng,
                ...
                hover:bg-green-300 bg-green-200 rounded-md h-6 w-[45%] px-2 flex items-center gap-3   '>
...
export default Inner_component_compont;
